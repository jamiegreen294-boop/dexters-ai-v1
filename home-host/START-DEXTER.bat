...
curl.exe -L --fail --silent --show-error "https://raw.githubusercontent.com/jamiegreen294-boop/dexters-ai-v1/build/real-dexter-ai/home-host/server.mjs" -o "%TEMP%\dexter-server.mjs"
if not errorlevel 1 (
